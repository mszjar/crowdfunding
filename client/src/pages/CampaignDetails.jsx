            ...
            <div className="mt-[20px] flex flex-col gap-4">
              {donators.length > 0 ? (
                donators.map((item, index) => (
                  ...
                  >
                    <p className="font-epilogue font-normal text-[16px] text-[rgba(0,0,0,0.8)] leading-[26px] break-ll">
                      {index + 1}. {item.donator}
                    </p>
                    <p className="font-epilogue font-normal text-[16px] text-[rgba(0,0,0,0.7)] leading-[26px] break-ll">
                      {item.donation}
                    </p>
                  </div>
                ))
